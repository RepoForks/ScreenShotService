package com.simoncherry.screenshotservice.util;
...
public class BitmapUtil {
    ...
    public static Bitmap decodeSampledBitmap(Bitmap originBitmap, float scaleRatio) {
        int width = (int) (originBitmap.getWidth() * scaleRatio);
        int height = (int) (originBitmap.getHeight() * scaleRatio);
